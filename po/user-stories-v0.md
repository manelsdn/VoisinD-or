...
| US-11 | En tant que demandeur, je veux voir le détail d'un profil jeune afin de choisir en confiance. | MUST | Le profil affiche la distance, les services, la disponibilité et une courte présentation. |
| US-12 | En tant que jeune volontaire, je veux voir le détail d'une demande afin de savoir si je peux aider. | MUST | La demande affiche le bénéficiaire, le service, le lieu approximatif et le créneau. |
| US-13 | En tant qu'utilisateur, je veux filtrer par distance afin de rester dans mon quartier. | SHOULD | Les résultats changent selon le rayon choisi : 500 m, 1 km ou 2 km. |
| US-14 | En tant qu'utilisateur, je veux filtrer par disponibilité afin de trouver un créneau compatible. | SHOULD | Les résultats changent selon la disponibilité : aujourd'hui, demain ou ce week-end. |
| US-15 | En tant que demandeur, je veux confirmer un créneau afin d'organiser la rencontre. | SHOULD | La demande passe à un statut confirmé. |
| US-16 | En tant qu'utilisateur, je veux annuler une demande afin de gérer un changement. | COULD | Une annulation affiche un message clair. |
| US-17 | En tant qu'utilisateur, je veux lire la charte d'entraide afin de comprendre les règles. | MUST | La charte explique le respect, l'accord du proche et le pourboire libre. |
