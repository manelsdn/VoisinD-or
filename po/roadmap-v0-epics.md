...
|---|---|---|---|
| Compte et authentification | L'utilisateur doit pouvoir créer un accès et revenir facilement dans l'application. | Inscription par e-mail et lien magique, connexion sans mot de passe, déconnexion, gestion des erreurs et redirection vers l'accueil. | MUST |
...
| Services et demandes | Le besoin doit être clair pour éviter les malentendus. | Type de service, créneau proposé par le jeune, détails et statut de la demande. | MUST |
...
| Organisation et suivi | Après l'envoi d'une demande, l'utilisateur doit savoir où en est le service. | Statuts, suivi, conversation simple puis échange de numéro de téléphone pour officialiser avant la rencontre. | SHOULD |
...
Le scénario cible ajoute la messagerie, des statuts plus complets, l'échange de numéro de téléphone, davantage de données fictives et des profils enrichis.
