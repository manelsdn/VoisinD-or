...
- `index.html` : page principale du dossier projet et du site vitrine.
- `styles.css` : styles de la page, de la maquette et de l'affichage mobile.
- `app.js` : interactions de la maquette cliquable.
- `assets/` : logo, illustrations, vidéo et visuels utilisés par le site.
- `assets/personas/` : portraits des personas.
- `designer/` : livrables UX/UI et synthèse de la partie Designer.
- `po/` : roadmap V0, epics et user stories pour la partie Product Owner.
